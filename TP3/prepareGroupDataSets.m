...
%%
%%%%
function [training_input, training_output, test_input, test_output] = prepareGroupDataSets(handles)
...
%}
	...
	%FIXME: IMPLEMENT HERE THE EQUIVALENT CODE BUT NOW DETECTING GROUPS OF CRYSIS INSTEAD OF JUST UNITARY CRYSIS!!!!!

	[training_input, training_output, test_input, test_output] = prepareSingleDataSets(handles);
