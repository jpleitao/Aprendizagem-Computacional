...
%%
%%%%
function [true_positives, true_negatives, false_positives, false_negatives, invalid_data] = interpretResults(handles, results)
    ...
    for i=1:number_cols_results
        ...
        if (current_case(1) == 0 && current_case(2) == 1)%Non-ictal: negative
            if (current_answer(1) == 0 && current_answer(2) == 1)%True negative
        ...
        else%current_case(1) == 1 && current_case(2) == 0 --> Ictal: positive
            if (current_answer(1) == 1 && current_answer(2) == 0)%True positive
