...
O presente trabalho foca-se na previsão e identificação de  epiléticas, com base em informação de sinais cerebrais, recolhidos através da realização de um \emph{EEG} (ElectroEncefaloGrama).
...
\textbf{FIXME: MUDAR INTERFACE GRÁFICA PARA PERMITIR ALTERAR DIMENSIONALIDADE DOS DADOS E FAZER REFERÊNCIA A ISSO NESTA SECÇÃO!!!}
