...
\item Número de \emph{validation checks} necessários para terminar o treino igual a $15$
...
Analisando os resultados obtidos, torna-se evidente

%Dividir isto em: Testes primeira abordagem --> Os que já temos, adicionar mais testes para as redes que tiveram melhores resultados, um teste com menos neurónios por camada e outro com mais neurónnios por camada. Dizer que poderíamos ter só ua camada escondida, pois de acordo com a bibliografia desde que tenhamos neuronios suficientes uma so camada escondida consegue produzir os mesmos resultados que várias camadas escondidas. Identificar das redes que inicialmente tiveram melhores resultados, a sua tendencia nos novos testes

%Nos testes que ja temos falar que sse tinha uma performance miseravel e que por isso nao adicionamos aqui os resultados
