...
% Last Modified by GUIDE v2.5 05-Nov-2014 01:37:37
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    [handles.training_input, handles.training_output, handles.test_input, handles.test_output] = getTrainingAndTestingData(crysis_indexes, Trg, FeatVectSel, handles.percentage_training);
