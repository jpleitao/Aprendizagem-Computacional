% Aprendizagem Computacional, DEI, 2014 blalalalalalalal
% digitaliza��o de um car�cter desenhado manualmente .
% Usa-se para construir as matrizes de dados P, que se guarda em formato .mat 
% Serve tamb�m para estabelecer os vectores alvo ("target") num problema de
...
% uma quadr�cula 5x10. Desenha-se um algarismo em cada c�lula.
...
%Resumindo:
% 1� Corre-se mpaper (sem fazer classifica��o, comentando a linha feval n� 190 neste ficheiro)
...
% 3� Desenham-se, com muito jeito, os caracteres perfeitos na grelha do
% mpaper, que ser�o guardados como a matriz T, desactivando a linha 181 e
% activando a linha 199 deste ficheiro. 

% 4� Para se graficar cada entrada numa grelha, usa-se a fun��o grafica
...
function Dn(varargin)
      switch get(gcf, 'SelectionType')   % clicked mouse button
       ...
       case 'normal'  % left     se carregar no bot�o esquerdo do rato
        ...
        case 'extend'  % middle  se carregar no bot�o do meio do rato
            disp('----------- Classify -----------')
 ...
 % em data.X. Seguindo a nota��o usada em Computa��o Adaptativa, poderemos
 % construir a partir deles o vector de entradas P, fazendo simplesmente
             ...
             ind=find( sum(data.X) ~= 0);% considerar em ind as colunas de soma n�o-nula; se uma coluna tem soma nula,
               %� porque no quadrado respectivo nada se escreveu (n�o h�
               %nenhum 1).
             save P
             save ind
 ...
 % neste momento est�o na directoria de trabalho (indicada na janela
